...
namespace MGJ3.Components
{
        ...
        ,IPhysics2dBody
    {
        ...
        public void Tick(GameTime gameTime)
        {
            ...
            float accelForce = 64000f; // meters/sec
        ...
        /// <summary>
        /// Returns the velocity needed to jump d blocks high from.
        /// </summary>
        /// <param name="d">The distance in metters. or.. number of 1x1 meter blocks</param>
        /// <returns>velocity</returns>
        /// <remarks>You need to multiply velocity with mass to get the needed impulse to make body jump d blocks high</remarks>
        private float BlocksToVelocity(float d)
        {
            float g = -_bodyImpl.Physics2dPlane.World.Gravity.Y;
            double velocity = Math.Sqrt(2 * g * d);
